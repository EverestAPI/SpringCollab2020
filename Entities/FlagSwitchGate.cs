...
namespace Celeste.Mod.SpringCollab2020.Entities {
    ...
    /// </summary>
    [CustomEntity("SpringCollab2020/FlagSwitchGate")]
    [Tracked]
    class FlagSwitchGate : Solid {
        ...
        public FlagSwitchGate(EntityData data, Vector2 offset)
            ...
            icon = new Sprite(GFX.Game, iconAttribute == "vanilla" ? "objects/switchgate/icon" : $"objects/SpringCollab2020/flagSwitchGate/{iconAttribute}/icon");
            Add(icon);
        ...
        public override void Render() {
            ...
            for (int i = 0; i <= widthInTiles; i++) {
                for (int j = 0; j <= heightInTiles; j++) {
                    ...
                    nineSlice[tilePartX, tilePartY].Draw(Position + base.Shake + new Vector2(i * 8, j * 8));
                }
            }
